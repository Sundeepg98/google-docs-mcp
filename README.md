...
operations into 107 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 107 tools) with descriptions.
...
4. Save → start a new chat. All 107 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
