...
operations into 100 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 100 tools) with descriptions.
...
4. Save → start a new chat. All 100 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
