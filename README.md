...
operations into 97 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 97 tools) with descriptions.
...
4. Save → start a new chat. All 97 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
