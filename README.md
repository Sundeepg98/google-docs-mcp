...
operations into 110 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 110 tools) with descriptions.
...
4. Save → start a new chat. All 110 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
