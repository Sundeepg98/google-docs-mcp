...
operations into 139 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 139 tools) with descriptions.
...
4. Save → start a new chat. All 139 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
