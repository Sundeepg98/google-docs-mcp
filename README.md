...
operations into 140 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 140 tools) with descriptions.
...
4. Save → start a new chat. All 140 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
