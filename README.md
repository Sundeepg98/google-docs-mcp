...
operations into 93 tools (primarily `gdocs_*`, plus `gsheets_*` /
...
authoritative list (all 93 tools) with descriptions.
...
4. Save → start a new chat. All 93 tools appear (`gdocs_*` plus the `gsheets_*` / `gslides_*` / `as_*` services).
