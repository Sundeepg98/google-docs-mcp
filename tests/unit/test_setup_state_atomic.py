...
def test_save_state_crash_leaves_original_intact(tmp_path):
    ...
    from appscriptly.setup_state import save_state, load_state, state_path
...
def test_save_state_cleans_up_tmpfile_on_failure(tmp_path):
    ...
    from appscriptly.setup_state import save_state, state_path
    ...
    import appscriptly.setup_state as ss_mod
