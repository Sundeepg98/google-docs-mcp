...
_log = logging.getLogger("appscriptly.user_store")
...
def init_default_backend_from_env() -> StorageBackend:
    ...
    See ``appscriptly.storage.backend_selector.select_backend``
...
def with_backend(backend: StorageBackend) -> Iterator[StorageBackend]:
    ...
    Example:
        ...
        from appscriptly.user_store import InMemoryBackend, with_backend, save_state
